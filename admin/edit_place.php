<?php
    ...
    $sql = "UPDATE `place_details` SET `pname`='$nam',`pdesc`='$desc',`pimages`='$image',`province_key`='$cate' WHERE p_id='$id'";
                ...
                <?php
                    ...
                    <div class="place-details">
                        ...
                        <div class="input">
                            ...
                            <input type="text" name="pdesc" id="" required class="form-control" value="<?php echo $data['pdesc']?>"><br>
                            ...
                            <input type="submit" name="update" value="Update Place details">
                        </div>
                    </div>
                    <?php } } ?>
                </form>
