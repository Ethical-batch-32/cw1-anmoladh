...
<html lang="en">
    ...
    <body id="body-pd">
        ...
        <div class="list-header">
            <h3>Photo Gallery <a href="add_photo.php">Add Photo</a></h3>
        </div>
        <table class="plist">
            <thead class="heading">
                <tr>
            ...
            <?php
                ...
                $statement = "gallery ORDER BY id asc"; //you have to pass your query over here
                ...
                while($data=mysqli_fetch_array($res))
                    ...
                    <tr>
                        ...
                        <td><?php echo "<img src='../images/".$data['images']."'>";?></td>
                        <td><?php echo $data['name'];?></td>
                        <td><?php echo $data['pro_key'];?></td>
                        <td> <a href="edit_photo.php?p_id=<?php echo $data["id"];?>"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="manage_gallery.php?del=<?php echo $data["id"];?>" onclick="return confirm('Are you sure?');"><i class="fas fa-times-circle"></i></a>
                        </td>
                    </tr>
                <?php } ?>        
            </tbody>
