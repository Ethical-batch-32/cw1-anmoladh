<?php
    ...
    if(isset($_GET['del'])){
        $id=$_GET['del'];
        mysqli_query($con,"DELETE FROM user_details WHERE c_id = '$id'");
    }
?>
    ...
    <body id="body-pd">
        ...
        <table class="plist">
            ...
            <?php
                ...
                $statement = "user_details ORDER BY c_id asc"; //you have to pass your query over here
                ...
                while($data=mysqli_fetch_array($res))
                    ...
                    <tr>
                        ...
                        <td><?php echo "<img src='../images/".$data['c_photo']."'>";?></td>
                        <td><?php echo $data["city"];?></td>
                        <td><a href="manage_customers.php?del=<?php echo $data["c_id"];?>" onclick="return confirm('Are you sure?');"><i class="fas fa-times-circle"></i></a></td>
                    </tr>
                <?php } ?>        
            </tbody>
        </table>
