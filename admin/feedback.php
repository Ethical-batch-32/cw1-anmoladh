<?php
    ...
    if(isset($_GET['del'])){
        $id=$_GET['del'];
        mysqli_query($con,"DELETE FROM reviews WHERE review_id = '$id'");
    }    
?>
            ...
            <?php
                ...
                while($data=mysqli_fetch_array($res))
                    ...
                    <tr>
                        ...
                        <td><a href="feedback.php?del=<?php echo $data["review_id"];?>" onclick="return confirm('Are you sure?');"><i class="fas fa-times-circle"></i></a></td>
                    </tr>
                <?php } ?>        
            </tbody>
        </table>
